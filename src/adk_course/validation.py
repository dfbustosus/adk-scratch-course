...
def main() -> None:
    ...
    try:
        ...
        console.print(f"  - Environment variables: {len(status['environment_variables'])} configured")
        console.print(f"  - Google Cloud: {'✓ Connected' if status['google_cloud_setup'] else '⚠ Not configured'}")
