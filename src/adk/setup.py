...
This is an ADK Course project for learning Google's Agent Development Kit
(ADK).
...
1. Scaffold a new ADK agent package:
   ```bash
   adk-course scaffold my-agent
   ```

2. Launch the ADK Dev UI and select your agent:
   ```bash
   adk web
   ```

3. Or run your agent in the terminal:
   ```bash
   adk run my-agent
   ```
...
"""
        ...
        console.print(
            f"\n[green]🎉 Project '{project_name}' created " f"successfully![/green]"
        )
